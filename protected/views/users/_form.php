...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'userpower'); ?>
		<?php echo $form->textField($model,'userpower'); ?>
		<?php echo $form->error($model,'userpower'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'loginfrequency'); ?>
		<?php echo $form->textField($model,'loginfrequency'); ?>
		<?php echo $form->error($model,'loginfrequency'); ?>
	</div>
